...
public interface Renderer {
    ...
    /**
     * Adds the given page number to the beginning of the queue (highest priority)
     * and adds the surrounding page numbers afterwards. A constant determines how
     * many page numbers should be rendered.
     *
